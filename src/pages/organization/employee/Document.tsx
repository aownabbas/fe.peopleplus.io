...
import { Box, Card, Container, Stack, TableBody } from '@mui/material'

// local imports
import { Category } from '@sections/organization/employees/document/Category'
import { DocumentListing } from '@sections/organization/employees/document/DocumentListing'
...
const Document = () => {
	...
	useEffect(() => {
		dispatch(getEmployeeDocumentAction(uuid))
	}, [uuid])
