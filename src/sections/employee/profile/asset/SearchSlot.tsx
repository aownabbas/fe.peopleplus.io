...
export const SearchSlot: FC<ProductListSearchProps> = (props) => {
	...
	const searchLabel = tokens.asset.search_slot.filter.asset_name
	...
	const statusOptions: Option[] = [
		{
			...
			value: t(tokens.asset.status.active),
		},
		{
			label: t(tokens.asset.status.deactivate),
			value: t(tokens.asset.status.deactivate),
		},
	]
	...
	const showChips = chips.some((chip) => chip.field !== 'name')

	//above line of code return true false
